...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 702544,
    DYNAMIC_BASE = 5945424,
    DYNAMICTOP_PTR = 702384;
...
var ASM_CONSTS = {
 ...
 569592: function() {return STACK_MAX;},  
 569614: function() {return TOTAL_STACK;},  
 643339: function($0, $1) {MONO.string_decoder.decode($0, $0 + $1, true);},  
 643622: function($0, $1, $2) {var str = MONO.string_decoder.decode ($0, $0 + $1); try { var res = eval (str); if (res === null || res == undefined) return 0; res = res.toString (); setValue ($2, 0, "i32"); } catch (e) { res = e.toString (); setValue ($2, 1, "i32"); if (res === null || res === undefined) res = "unknown exception"; } var buff = Module._malloc((res.length + 1) * 2); stringToUTF16 (res, buff, (res.length + 1) * 2); return buff;},  
 644041: function() {var err = new Error(); console.log ("Stacktrace: \n"); console.log (err.stack);}
};
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 702448, 4), 702448);function _gmtime_r(time, tmPtr) {
